...
// const textEl = createTextNode('app');
// const App = createElement('div', {id: 'app'}, textEl, '--maoy', ' fj');
...
/**
 * V6 继续优化
 * 仿照：ReactDOM.render(<App />, document.getElementById('root'));
 */
function createElement (type, props, ...children) {
  return {
    type,
...
const textEl = createTextNode('app');
const App = createElement('div', {id: 'app'}, textEl, '--maoy', ' fj1');

// render(App, document.querySelector("#root"));

// ReactDOM.render(<App />, document.getElementById('root'));

// 仿照ReactDOM.createRoot(document.querySelector("#root").render(App));
